...
def main(opts) -> None:
    """
    Main evaluation loop for CMIP on various parameter settings and distributions.
    Args:
    ...
    for param in param_all:
        ...
        # Load dataset
        dataset_path = (
            f"data/data_distribution/tsp_{opts.distribution}{param[0]}_100_seed3333.pkl"
        )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="CMIP Evaluation on different distribution"
    )
    ...
    parser.add_argument(
        "--opt_cost_path",
        type=str,
        default="pretrain/distribution_opt.pt",
    ...
    parser.add_argument(
        ...
        type=str,
        default="cluster",
        help="Distribution of mTSP datasets",
    )
    parser.add_argument(
        "--val_size",
        type=int,
