...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CMIP Evaluation with IP-based Refinement")
    ...
    parser.add_argument('--opt_cost_path', type=str, default='pretrain/opt_cost.pt', help='Path to optimal cost file')
